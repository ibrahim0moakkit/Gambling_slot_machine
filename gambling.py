...
MAX_LINES=3 #conventional in python all capitals as a global constant not gonna change
MAX_BET=100
MIN_BET=1
...
def main():
    ...
    while True:
        ...
        if total_bet<=balance:
            ...
            print(f"Enter a bet amount within your balance range ${balance} .")
    ...
    print(f"You won on lins: ", *winnings_lines)
